    ...
    <div
      className={cn(
        "flex cursor-move items-start justify-between rounded-lg bg-white px-3 py-2 text-gray-900",
        {
          ...
          "border-4 border-amber-500": status === "Progress",
    ...
    >
      <div>
        <h3
          className={
            status === "Done"
              ? "font-medium text-lg text-gray-500 line-through"
        ...
        <p
          className={
            status === "Done"
              ? "font-regular text-sm text-gray-400 line-through"
              : "font-regular text-sm text-gray-500 "
          }
        >
          {description}
        </p>
